...
<div className="max-w-[85rem] m-auto ">
  ...
  <div className="text-center my-8 space-y-2">
    ...
    <p className='px-3 font-light md:w-[70%] m-auto  md:text-2xl '>Taking care of our pets brings out the best in us. But it’s not easy by any means. We, at Wagr, are committed to helping you be the best pet parent you can be. Because we believe that our pets deserve our very best!</p>
  </div>
</div>
...
<div className="max-w-[85rem] m-auto ">
  <div className="whoRV flex flex-col items-center mt-8 px-3">
    ...
    <p className='md:w-[55rem] text-center my-4 '>We are a group of pet-parents, pet-lovers, storytellers, and creators, who have come together to make the world a better place for pets and their lovely parents.</p>
